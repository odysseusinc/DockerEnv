...
install_github("odysseusinc/CohortMethod", ref = "big-query-fix2", upgrade = "never")
...
install_github("odysseusinc/DatabaseConnector", ref = "big-query-fix2", upgrade = "never")
...
install_github("odysseusinc/FeatureExtraction", ref = "big-query-fix2", upgrade = "never")
install_github("OHDSI/OhdsiRTools", ref = "v1.7.0", upgrade = "never")
#install_github("OHDSI/SqlRender", ref = "638ee0f", upgrade = "never")
install_github("odysseusinc/SqlRender", ref = "big-query-fix2", upgrade = "never")
...
install_github("odysseusinc/PatientLevelPrediction", ref = "big-query-fix2", upgrade = "never")
