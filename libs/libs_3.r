library("devtools")
install_version("openxlsx", version = "4.2.3", type = "source", upgrade_dependencies = FALSE)
...
install_version("plotly", version = "4.9.3", type = "source", upgrade_dependencies = FALSE)
...
install_version("RcppParallel", version = "5.0.2", type = "source", upgrade_dependencies = FALSE)
...
install_version("rJava", version = "0.9-13", type = "source", upgrade_dependencies = FALSE)